...
def reveal_stars_animation(
    chat_id, message_id, size, star_positions,
    success, lucky_cells, delay=0.5
):
    total = size * size
    grid = ["🟦"] * total
    ...
    for pos in star_positions:
        ...
        edit_message(
            chat_id,
            message_id,
            f"💎 <b>Analizando zonas seguras...</b>\n\n{field_text}"
        )

    # 🔥 финал ПОСЛЕ анимации
    final_text = (
